...
- 電子發票證明聯或明細若出現「總計」，也優先取「總計」後面的數字作為 final total
...
- 傳統手開三聯式發票的號碼常出現在左上角，格式是兩個英文字母後面接數字，例如 KT00983801
- 這種格式下，左上角那組英文字母加數字應優先當作 invoice_number

【店家規則】
- 店家請盡量只保留公司主名稱，不要把地址、電話、統編、分店代碼一起帶進去
- 不要把「買受人」當成店家；買受人是客戶/購買方，不是賣方
- 傳統手開發票若右下角「營業人蓋用統一發票專用章」區塊有藍色或圓角公司章，優先讀取該印章第一行作為店家名稱
- 若印章第一行是最清楚的公司名稱，請直接用該行，不要混入下面的統編、電話或地址
- 若是電子發票證明聯或明細，且左側有「賣方：」欄位，店家優先取「賣方」後面的公司名稱
